class Dog {
    ...
    get item() {
        ...
        divCol2.append(this.paragrah("Breed", this.breed));
        divCol2.append(this.paragrah("Color", this.color));
        divCol2.append(this.paragrah("Age", this.age));
        divCol2.append(this.paragrah("Size", this.size));
